...
script="/nfs/research/icortes/belzen/src/lta_detection.clean.R"
#resources="--mem=150Gb --time=35:00:00"
resources="--mem=150Gb --time=02:00:00"
...
config_cohort="/nfs/research/icortes/belzen/src/TCGA_WGD_analysis/lta_detection.clean.conf"
